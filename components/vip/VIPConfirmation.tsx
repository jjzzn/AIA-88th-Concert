...
const VIPConfirmation: React.FC<Props> = ({ room, seats, attendees, qrTokens, onReset }) => {
  ...
  return (
    <div className="space-y-4 pb-6 animate-in fade-in zoom-in-95 duration-700">
      {/* Step Indicator */}
      <div className="px-2">
      ...
      <div className="text-center space-y-2">
        ...
        <div className="space-y-0.5">
          <h2 className="text-xl font-bold text-slate-900">จองสำเร็จ!</h2>
          <p className="text-slate-500 text-xs">ตั๋ว VIP ของคุณพร้อมใช้งานแล้ว</p>
        </div>
      </div>
              ...
              >
                ...
                >
                  ...
                  <div className="p-5 space-y-4 flex-1">
                    ...
                    <div className="text-center border-b border-slate-50 pb-3">
                      <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">ATTENDEE NAME</p>
                    ...
                    <div className="border-b border-slate-100 pb-3">
                      <div className="grid grid-cols-3 gap-3 text-center">
                        <div>
                          ...
                          <p className="text-base font-black text-slate-900">{room.roomNumber}</p>
                        </div>
                        <div>
                          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">ROW</p>
                          <p className="text-base font-black text-slate-900">{seat.row}</p>
                        </div>
                        <div>
                          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">SEAT</p>
                          <p className="text-base font-black text-[#E4002B]">{seat.number}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-center py-1">
                      <div className="p-4 bg-[#F8FAFC] rounded-[32px] border border-slate-100 shadow-[inset_0_2px_8px_rgba(0,0,0,0.03)]">
                        <QRCode 
                          value={qrToken}
                          size={140}
                          className="rounded-lg"
                        />
                        <p className="text-[10px] text-center text-slate-600 font-mono mt-2 tracking-wide font-bold">
                          {qrToken}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 pt-1">
                      <div className="flex items-center gap-3 text-slate-800">
                        <div className="w-8 h-8 bg-red-50 rounded-xl flex items-center justify-center shrink-0">
                          <Calendar className="w-3.5 h-3.5 text-[#E4002B]" />
                        </div>
                        <span className="text-xs font-bold">24 MAY 2025 • 19:00</span>
                      </div>
                      <div className="flex items-center gap-3 text-slate-800">
                        <div className="w-8 h-8 bg-red-50 rounded-xl flex items-center justify-center shrink-0">
                          <MapPin className="w-3.5 h-3.5 text-[#E4002B]" />
                        </div>
                        <span className="text-xs font-bold leading-tight">IMPACT ARENA, MUANG THONG THANI</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="px-2">
        {isSingleTicket ? (
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#E4002B] text-white rounded-2xl font-bold text-sm hover:bg-red-700 transition active:scale-95 shadow-lg shadow-red-500/25"
          >
          ...
          <div className="space-y-2">
            <p className="text-[10px] font-bold text-slate-500 text-center uppercase tracking-wider">บันทึกตั๋วแต่ละใบ</p>
              ...
              {attendees.map((attendee, index) => {
                ...
                return (
                  <button
                    ...
                    className="flex flex-col items-center gap-1.5 py-2.5 px-3 bg-white border border-slate-200 rounded-2xl text-slate-800 font-bold text-xs hover:bg-slate-50 hover:border-[#E4002B] transition active:scale-95 shadow-sm"
                  >
                    <Download className="w-3.5 h-3.5 text-[#E4002B]" />
      ...
      <div className="text-center pt-2">
        <button 
          onClick={onReset}
          className="text-slate-400 text-xs font-bold uppercase tracking-widest hover:text-[#E4002B] transition py-2 active:scale-95"
        >
          กลับสู่หน้าหลัก
        </button>
      </div>
